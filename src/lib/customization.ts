 ...
 * Each customization is just a handful of base colors — avatarSprites.ts and
 * roomSprites.ts derive the small highlight/shadow accents automatically
 * (see lib/color.ts) so any combination still looks intentional.
 */
...
export const ROOM_SWATCHES: Record<keyof RoomCustomization, string[]> = {
